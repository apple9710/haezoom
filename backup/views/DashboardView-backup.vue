      ...
      <aside v-if="isEditMode" class="widget-sidebar" :class="{ 'sidebar-hidden': !sidebarOpen }">
        ...
        <div class="widget-categories">
          ...
          <div class="category-section">
            ...
            <div class="widget-list">
              <div class="widget-item" @click="showWidgetSelector('solar_generation', '태양광 발전량')">
                <span class="widget-icon"><img src="@/assets/images/icon/1.png" alt=""></span>
          ...
          <div class="category-section">
            ...
            <div class="widget-list">
              <div class="widget-item" @click="showWidgetSelector('equipment_control', '설비 제어')">
            ...
            <div class="dashboard-right">
              <div class="welcome-text">
                <span class="user-name">
                  ...
                  <span>반가워요 <span class="hand_icon">👋</span></span>
                </span>
